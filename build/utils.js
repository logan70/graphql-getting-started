...
const fileBasePath = 'https://github.com/logan70/graphql-getting-started/blob/master/'
const dirBasePath = 'https://github.com/logan70/graphql-getting-started/tree/master/'
...
const getChapterNum = str => Number(/(\d+)-\w*/.exec(str)[1])
